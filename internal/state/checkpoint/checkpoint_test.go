...
func TestRestorePreservesGB18030Encoding(t *testing.T) {
	...
	original := "\u4f60\u597d\n\u65e7\u884c\n"
	edited := "\u4f60\u597d\n\u65b0\u884c\n"
	originalRaw := encodingtest.MustEncode(original, fileenc.GB18030)
	...
	if err := os.WriteFile(a, encodingtest.MustEncode(edited, fileenc.GB18030), 0o644); err != nil {
		t.Fatal(err)
	}
...
func BenchmarkRestoreGB18030Encoding(b *testing.B) {
	...
	originalRaw := encodingtest.MustEncode(original, fileenc.GB18030)
	editedRaw := encodingtest.MustEncode(edited, fileenc.GB18030)
	if err := os.WriteFile(a, originalRaw, 0o644); err != nil {
		b.Fatal(err)
	}
